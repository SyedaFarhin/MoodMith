...
//     </footer>
<footer className="py-16 px-4 bg-gradient-to-br from-gray-900 via-purple-900 to-indigo-900 text-white">
<div className="max-w-6xl mx-auto">
  ...
  >
    <p className="text-xl md:text-2xl mb-8 font-medium">
      Made with Love, Mithai & Machine Learning. 🇮🇳 → 🌍
    </p>
    ...
    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
      ...
      <button className="bg-gradient-to-r from-purple-500 to-indigo-500 px-8 py-4 rounded-full font-bold text-lg hover:from-purple-600 hover:to-indigo-600 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl w-full sm:w-auto">
        Join Our Tribe 💖
      </button>
    </div>
    ...
    <div className="border-t border-white/20 pt-8">
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-white/70">
        <p>© 2024 MoodMithAI. All rights reserved.</p>
