...
<div className="bg-[#f1f1f1] p-2 w-full mb-3 rounded-md flex items-center justify-between">
  ...
  <Button
        ...
        onClick={handleClick}
        className="!bg-white !text-[12px] !text-[#000] capitilize !border-2"
      >
        Highest to Lowest
      </Button>
      <Menu
      ...
      >
        <MenuItem  className="!text-[13px] !text-[#000] capitilize !border-2" onClick={handleClose}>Profile</MenuItem>
        <MenuItem className="!text-[13px] !text-[#000] capitilize !border-2" onClick={handleClose}>My account</MenuItem>
        <MenuItem className="!text-[13px] !text-[#000] capitilize !border-2" onClick={handleClose}>Logout</MenuItem>
      </Menu>
  </div>
</div>
