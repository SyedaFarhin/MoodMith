...
const minusQty = () => {
 ...
 <div className="flex items-center flex-col justify-between h-[40px] absolute top-0 right-0 z-50">
  <Button className="min-w-[30px] w-[30px] h-[20px] !text-[#000] !rounded-none" onClick={plusQty}>
    <FaAngleUp className="text-[12px] opacity-55" />
  </Button>
  <Button className="min-w-[30px] w-[30px] h-[20px] !text-[#000] !rounded-none" onClick={minusQty}>
