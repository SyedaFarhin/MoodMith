...
const CartPanel = () => {
  ...
  <div className="cartItem w-full flex items-center gap-4 border-b pb-4">
    <div className="img w-[25%] overflow-hidden h-[80px] rounded-md">
     <Link to="/product/123" className="block group">
     <img
        src="https://serviceapi.spicezgold.com/download/1742453374892_1000014029787-Green-GREEN-1000014029787_06-2100.jpg"
  ...
  <Link to="/product/123" className="link transition-all">Beige Spread Collar Classic Slim Fit Cotton Casual Shirt</Link>
  </h4>
